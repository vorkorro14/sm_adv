...
#define ETHMOD_SPI_DDR	DDRB
#define ETHMOD_SPI_PORT	PORTB
#define ETHMOD_SPI_CS		(1<<PB4)
#define ETHMOD_SPI_MOSI	(1<<PB5)
#define ETHMOD_SPI_MISO	(1<<PB6)
#define ETHMOD_SPI_SCK	(1<<PB7)
...
void ethmod_bfc(uint8_t adr, uint8_t mask); // Clr bits (reg &= ~mask)
void ethmod_bfs(uint8_t adr, uint8_t mask); // Set bits (reg |= mask)
...
#define ETHMOD_BUFSIZE	0x2000
#define ETHMOD_RXSIZE		0x1A00
#define ETHMOD_BUFEND		(ETHMOD_BUFSIZE-1)

#define ETHMOD_MAXFRAME	512

#define ETHMOD_RXSTART	0
#define ETHMOD_RXEND		(ETHMOD_RXSIZE-1)
#define ETHMOD_TXSTART	ETHMOD_RXSIZE

#define ETHMOD_SPI_RCR	0x00
#define ETHMOD_SPI_RBM	0x3A
#define ETHMOD_SPI_WCR	0x40
#define ETHMOD_SPI_WBM	0x7A
#define ETHMOD_SPI_BFS	0x80
#define ETHMOD_SPI_BFC	0xA0
#define ETHMOD_SPI_SC		0xFF

#define ETHMOD_ADDR_MASK	0x1F
#define ETHMOD_COMMON_CR	0x1B
